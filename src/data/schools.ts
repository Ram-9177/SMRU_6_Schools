...
import nstLogo from "../assets/partner-logos/01_newton_school_of_technology.png";
import qtstLogo from "../assets/partner-logos/02_quality_thought_school_of_technology.png";
import nextgenLogo from "../assets/partner-logos/03_nextgen_powered_by_ctpl.png";
import bytexlLogo from "../assets/partner-logos/04_bytexl.png";
import velocesLogo from "../assets/partner-logos/05_veloces_campus.png";
import iiatLogo from "../assets/partner-logos/06_iiat.png";
import bbLogo from "../assets/partner-logos/07_blackbuck_education.png";
import edridgeLogo from "../assets/partner-logos/08_edridge_learning_solutions.png";
import emversityLogo from "../assets/partner-logos/09_emversity_industry_partner.png";
import edinLogo from "../assets/partner-logos/10_edinbox.png";
import istLogo from "../assets/partner-logos/11_intellipaat_school_of_technology.png";
import niatLogo from "../assets/partner-logos/12_niat.png";
...
export const EDU_PARTNERS = {
  ...
  EMVERSITY: {
    ...
    logo: emversityLogo,
    iframeUrl: "https://emversity.com/university-partners/st-marys-rehabilitation-university-hyderabad",
    embedCode: ""
  },
  EDRIDGE: {
    code: "EDRIDGE",
...
export const schools: SchoolData[] = [
        ...
        programs: [
          {
            ...
            campus: "SMRU Campus, Hyderabad, Telangana",
            ...
            schoolTitle: "School of Health & Allied Health Sciences - St. Mary's Rehabilitation University",
            schoolDescription: text(
              "Delivered through a partnership model: SMRU provides the academic and degree framework while Emversity supplies industry-skilling, AR/VR simulation labs, employer-co-designed modules, structured clinical internships, and placement support."
            ),
            highlights: [
            ...
            eligibilityNote: text(
              "Requires 10+2 with Physics, Chemistry and Biology/Mathematics; selection based on SMRU entrance or merit as applicable."
            ),
            specializations: [
              "Neuro Physiotherapy",
            ...
            feeNotes: [
              "Total program fee: ₹8 Lakhs payable to SMRU",
              "Scholarships and education loans available as per university policy"
            ],
            accreditation: text(
              "St. Mary's Rehabilitation University (SMRU) is UGC recognised; the program aligns with NCAHP and RCI guidelines. Degree and certifications are awarded by SMRU. Applicants should verify current regulatory recognition on official channels."
            ),
            whyChoose: [
        ...
        programs: [
          {
            ...
            schoolTitle: "School of Rehabilitation & Allied Health Sciences - St. Mary's Rehabilitation University",
            schoolDescription: text(
              "This program is delivered through a partnership model: SMRU provides the academic framework and degree conferral while Emversity delivers industry-skilling, AR/VR simulation labs, employer-co-designed modules, structured clinical internships, and placement assistance."
            ),
            highlights: [
            ...
            eligibilityNote: text(
              "Requires 10+2 with Physics, Chemistry and Biology/Mathematics; minimum aggregate as per SMRU norms. Admissions are conducted by SMRU through the official admissions portal."
            ),
            specializations: [
            ...
            accreditation: text(
              "St. Mary's Rehabilitation University (SMRU) is UGC recognised; the program aligns with NCAHP guidelines. Degree, examinations, and certificates are awarded by SMRU. Applicants should verify current regulatory recognition on official channels."
            ),
            whyChoose: [
        ...
        programs: [
          {
            ...
            admissionProcess: [
              ...
              "Receive admission offer from SMRU and complete fee payment through the university portal",
            ...
            accreditation: text(
              "SMRU is recognised by the UGC and aligns this program with NCAHP guidelines. The degree is awarded solely by SMRU, while Emversity handles the industry-skilling component. Students should independently verify the current NCAHP recognition status from the official NCAHP website."
            ),
            whyChoose: [
              "Partnership model combining SMRU academics with Emversity industry-skilling",
            ...
            feeNotes: [
              ...
              "Fees are payable directly to SMRU as per the university schedule",
              "Scholarships may be available on merit and category basis as per SMRU norms",
            ],
          },
          {
          ...
          },
          {
            ...
            schoolTitle: "School of Health & Allied Health Sciences - St. Mary's Rehabilitation University",
            schoolDescription: text(
              "The School of Health & Allied Health Sciences prepares students for applied clinical and rehabilitative careers across allied health fields. This program combines SMRU's academic framework with Emversity's industry-skilling modules to deliver practice-ready graduates."
            ),
            highlights: [
            ...
            eligibilityNote: text(
              "Requires 10+2 with Physics, Chemistry and Biology/Mathematics; minimum aggregate and category-based relaxations as per SMRU norms. Admissions processed by SMRU through the official admissions portal."
            ),
            eligibilityPoints: [
            ...
            feeNotes: [
              "Total program fee: ₹8 Lakhs payable directly to SMRU",
              "Scholarships available as per SMRU policy",
              "Education loans available from leading banks and NBFCs"
            ],
            overviewDetails: text(
              "SMRU provides the academic framework, degree conferral, examinations, and campus infrastructure, while Emversity delivers industry-skilling including AR/VR simulation labs, employer-co-designed modules, structured clinical internships, and placement assistance through a large network of healthcare employers."
            ),
            semesterSummary: text(
              "The curriculum aligns with NCAHP guidelines and progresses from foundational health sciences and visual sciences (Years 1–2), through core optometric sciences and clinical refraction (Years 2–3), to advanced diagnostics, contact lens practice, low vision rehabilitation, and internships (Years 3–5), concluding with a capstone project and professional readiness preparation."
            ),
            outcomes: text(
            ...
            accreditation: text(
              "St. Mary's Rehabilitation University (SMRU) is UGC recognised; the program is aligned with NCAHP guidelines. Degree, examinations, and certificates are awarded solely by SMRU. Applicants should verify current regulatory recognition on the official NCAHP site."
            ),
            whyChoose: [
          ...
          },
          {
            ...
            schoolTitle: "School of Health & Allied Health Sciences - St. Mary's Rehabilitation University",
            schoolDescription: text(
              "This program combines SMRU's academic governance with Emversity's industry-skilling to deliver practice-ready radiotherapy technologists, emphasising simulation, clinical postings, and treatment planning skills."
            ),
            highlights: [
            ...
            eligibilityPoints: [
              "10+2 with Physics, Chemistry and Biology/Mathematics (PCB/PCMB)",
              "Minimum aggregate as per SMRU guidelines"
            ],
            feeNotes: [
              "Total program fee: ₹7.2 Lakhs payable directly to SMRU",
            ...
            accreditation: text(
              "St. Mary's Rehabilitation University (SMRU) is UGC recognised; the program aligns with NCAHP standards. Degree and certifications are awarded by SMRU. Applicants should confirm current regulatory recognition on official channels."
            ),
            whyChoose: [
          ...
          },
          {
            ...
            accreditation: text("Degree awarded by St. Mary's Rehabilitation University; curriculum focus on contemporary forensic standards."),
            accreditationPoints: ["Awarded by St. Mary's Rehabilitation University", "Technical labs focused on experimental and investigative science"],
            whyChoose: [
  ...
  },
  {
    ...
    short: "Psychology",
    about: text("The School of Psychology at St. Mary's Rehabilitation University serves as a specialized center for mental health education and clinical training. Programs are structured around practical research and rehabilitative strategies, preparing students to evaluate behavioral patterns and implement psychological interventions in diverse community and medical settings."),
    departments: [
      {
        ...
        programs: [
          {
            ...
            accreditation: text("Degree recognized by RCI and UGC (Section 2(f)), establishing the academic eligibility needed for entrance to advanced clinical psychology pathways in India.")
          },
          {
            ...
            accreditation: text("Degree recognized by RCI and UGC (Section 2(f)), providing the credentials required for entrance to professional RCI-regulated programs.")
          },
      ...
      },
      {
        ...
        programs: [
          ...
          },
          {
            ...
            accreditation: text("Degree recognized by NAHC and UGC (Section 2(f)), providing required academic credentials for entrance to further regulated professional pathways.")
          }
        ]
      }
    ]
        ...
        programs: [
          {
            ...
            name: "B.Tech in Rehabilitation Engineering with Prosthetics & Orthotics / Assistive Technologies",
            level: "UG Program"
          },
          {
        ...
        programs: [
          {
            ...
            schoolTitle: "School of Engineering and Technology - St. Mary's Rehabilitation University",
            ...
            accreditation: text("Degree awarded by St. Mary's Rehabilitation University. Program aligned with global software engineering and architecture standards."),
            accreditationPoints: [
              "Degree awarded by St. Mary's Rehabilitation University",
          ...
          },
          {
            ...
            level: "UG Program",
            partnerCode: "NIAT",
            partnerCodes: ["NIAT", "QTST", "IST", "IIAT", "BYTEXL"],
            duration: "4 Years (8 Semesters)",
            ...
            accreditation: text("Degree awarded by St. Mary's Rehabilitation University. Program offered under the School of Engineering and Technology. Curriculum aligned with modern artificial intelligence and computing industry requirements."),
            accreditationPoints: [
              "Degree awarded by St. Mary's Rehabilitation University",
          ...
          },
          {
            ...
            name: "B.Tech Cyber Security AI/ML",
            level: "UG Program",
            partnerCode: "IIAT"
          },
          {
            slug: "btech-fintech-ai",
            name: "B.Tech FinTech & AI",
            level: "UG Program",
            partnerCode: "IIAT"
          },
          {
          ...
          },
          {
            ...
            name: "B. Tech Computer science in Cyber Forensic & Information Technology",
            level: "UG Program",
            partnerCode: "EDRIDGE"
          },
          {
            slug: "btech-cse-var",
            name: "B.Tech in CSE SPECIALIZATION IN VIRTUAL &AUGMENTED REALITY.",
            level: "UG Program",
            partnerCode: "VELOCES"
          }
        ]
        ...
        programs: [
          {
            ...
            overview: text("A broad and comprehensive legal education covering essential legal core subjects with practical training in moot courts, drafting, legal aid, and internships for litigation and advisory careers.")
          },
          {
            slug: "llb-hons",
            name: "LL.B. (Hons.)",
