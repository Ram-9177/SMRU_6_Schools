...
export const STATIC_PAGE_CONTENT: CmsPageContent[] = [
  {
    ...
    visibility: "public",
    status: "live",
    content: "rehab-focused curriculum | clinical training & outreach | 30+ years of experience | top placement record",
  ...
  },
  {
    ...
    visibility: "public",
    status: "live",
    content: "08071296016 | +91-7331119432 | reach@smru.edu.in | Near Ramoji Film City, Deshmukhi Village, Pochampally Mandal, Yadadri Bhuvanagiri District, Hyderabad, Telangana - 508284, India.",
    tags: ["contact", "footer"]
  },
  {
    id: "page-cta-apply",
  ...
  },
  {
    ...
    status: "live",
    ctaLabel: "WhatsApp",
    ctaLink: "https://wa.me/917331119438",
  ...
  },
  {
    ...
    visibility: "public",
    status: "live",
    content: "Modern hostels, advanced labs, sports complex, wellness center, green spaces, campus bike rental",
