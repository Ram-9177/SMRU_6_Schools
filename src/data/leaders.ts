...
export const leadershipGroups = {
  ...
  "Board of Management - BOM": [
    {
      ...
      role: "Vice-Chancellor",
      about: "B.A., M.Sc. (Defence Studies), PGDPM, Diploma in Public Administration, M.Phil., Ph.D. (IGNOU), MMS - Master of Management Studies"
    },
    {
    ...
    },
    {
      ...
      role: "Member",
      about: "Co-Founder,CEO - M/s. Zestwings (India UAE), Solutions Architect (Digital, IT & Cyber Governance) For St. Mary's Rehabilitation University"
    },
    {
    ...
    },
    {
      ...
      role: "Member",
      about: "Chief Operating Officer, St. Mary's Rehabilitation University"
    },
    {
      name: "Dr. B. Valli",
      role: "Member",
  ...
  "Sponsor Body": [
    ...
    },
    {
      name: "K.Sri Harsha",
      role: "Secretary",
      about: "Chief Executive Officer, St. Mary's Rehabilitation University"
    },
    {
      name: "K.Indraja",
      role: "Treasurer",
...
export const leaders = [
  {
    ...
    about: "Founder & Chairman of JSMI Educational Society. Visionary behind St. Mary's Rehabilitation University and umbrella rehabilitation focus.",
  },
  {
    slug: "co-founder",
    name: "Smt. C.V.N.V Bharathi",
    role: "Co-Founder & Pro-Chancellor",
    about: "Co-Founder of St. Mary's Rehabilitation University and Pro-Chancellor supporting the university's academic and institutional vision.",
  },
  {
    slug: "ceo",
