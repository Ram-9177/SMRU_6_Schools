...
const Navbar = ({ 
  ...
  return (
    <nav 
      className={`fixed ${isPartner ? "top-0" : "top-10"} left-0 right-0 z-[2000] h-[72px] lg:h-24 bg-[#0d315c] border-b-2 border-[#019e6e]/40 shadow-lg transition-all duration-300`}
    ...
    >
      <div className="flex h-full items-center justify-between lg:items-center lg:justify-between lg:py-0 lg:pr-8">
        ...
        <Link to="/" onClick={closeMenu} onMouseEnter={() => setActiveMenu(null)} className="flex h-full items-center justify-center shrink-0 bg-white cut-corner-badge shadow-md overflow-hidden transition-all duration-300 px-3 sm:px-4 lg:px-5 min-w-[112px] sm:min-w-[128px] lg:min-w-[160px]">
          <img src="/assets/Logo.png" alt="St. Mary's Rehabilitation University Logo" className="h-[72%] lg:h-[68%] w-auto object-contain" />
        </Link>

        {/* Main Nav */}
        <ul className="hidden flex-wrap items-center justify-end gap-x-6 gap-y-1 overflow-visible font-outfit [scrollbar-width:none] [&::-webkit-scrollbar]:hidden [&>li]:shrink-0 h-full lg:flex lg:flex-nowrap lg:gap-5 xl:gap-8 pr-4">
          <li onMouseEnter={() => setActiveMenu(null)}>
            <Link to="/" onClick={closeMenu} className="whitespace-nowrap text-[10px] lg:text-[12px] xl:text-[14px] font-black uppercase tracking-[0.08em] lg:tracking-[0.14em] xl:tracking-[0.2em] text-white/90 hover:text-[#ffaf3a] transition-all relative group py-2">
              Home
              <span className="absolute bottom-0 left-0 w-0 h-1 bg-[#ffaf3a] transition-all duration-200 group-hover:w-full" />
            </Link>
          </li>
          <li onMouseEnter={() => setActiveMenu(null)}>
            <Link to="/about" onClick={closeMenu} className="whitespace-nowrap text-[10px] lg:text-[12px] xl:text-[14px] font-black uppercase tracking-[0.08em] lg:tracking-[0.14em] xl:tracking-[0.2em] text-white/90 hover:text-[#ffaf3a] transition-all relative group py-2">
              About
              <span className="absolute bottom-0 left-0 w-0 h-1 bg-[#ffaf3a] transition-all duration-200 group-hover:w-full" />
            </Link>
          </li>
          ...
          >
            ...
            {isSchoolsOpen && (
              <div 
                className={`fixed top-[112px] lg:top-[136px] left-1/2 -translate-x-1/2 w-[95vw] max-w-[1100px] bg-white shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-slate-200 cut-corner-panel overflow-hidden flex animate-in fade-in slide-in-from-top-2 duration-200`}
                onMouseLeave={() => setActiveMenu(null)}
              >
          ...
          >
            ...
            {isAdmissionsOpen && (
              <div 
                className="fixed top-[112px] lg:top-[136px] left-1/2 -translate-x-1/2 w-[95vw] max-w-[1000px] bg-white shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-slate-200 cut-corner-panel overflow-hidden flex animate-in fade-in slide-in-from-top-2 duration-200"
                onMouseLeave={() => setActiveMenu(null)}
              >
                {/* Admissions Sidebar */}
          ...
          <li onMouseEnter={() => setActiveMenu(null)}>
            <Link to="/careers" onClick={closeMenu} className="whitespace-nowrap text-[10px] lg:text-[12px] xl:text-[14px] font-black uppercase tracking-[0.08em] lg:tracking-[0.14em] xl:tracking-[0.2em] text-white/90 hover:text-[#ffaf3a] transition-all relative group py-2">
              Careers
              <span className="absolute bottom-0 left-0 w-0 h-1 bg-[#ffaf3a] transition-all duration-200 group-hover:w-full" />
            </Link>
          </li>
          <li onMouseEnter={() => setActiveMenu(null)}>
            <Link to="/contact" onClick={closeMenu} className="whitespace-nowrap text-[10px] lg:text-[12px] xl:text-[14px] font-black uppercase tracking-[0.08em] lg:tracking-[0.14em] xl:tracking-[0.2em] text-white/90 hover:text-[#ffaf3a] transition-all relative group py-2">
              Contact
              <span className="absolute bottom-0 left-0 w-0 h-1 bg-[#ffaf3a] transition-all duration-200 group-hover:w-full" />
            </Link>
          </li>
          ...
          <li onMouseEnter={() => setActiveMenu(null)}>
            <Link to="/campus-360" onClick={closeMenu} className="whitespace-nowrap text-[10px] lg:text-[12px] xl:text-[14px] font-black uppercase tracking-[0.08em] lg:tracking-[0.14em] xl:tracking-[0.2em] text-white/90 hover:text-[#ffaf3a] transition-all relative group py-2">
              Campus 360
              <span className="absolute bottom-0 left-0 w-0 h-1 bg-[#ffaf3a] transition-all duration-200 group-hover:w-full" />
            </Link>
          </li>
