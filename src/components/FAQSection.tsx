      ...
      <div className="bg-[#f0f4f8] cut-corner-panel overflow-hidden border border-gray-200">
        <div className="flex flex-col sm:flex-row">
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-between px-5 py-4 text-left text-sm font-bold transition-colors ${
                    activeCategory === i
                      ...
                      : "text-gray-500 hover:text-[#0d315c] hover:bg-white/60"
                  }`}
                >
                  {cat.label}
                  <svg
                    className={`w-4 h-4 transition-transform ${activeCategory === i ? "rotate-0 text-[#0d315c]" : "text-gray-400"}`}
          ...
          <div className="flex-1 bg-white divide-y divide-gray-100">
            {filtered.length === 0 ? (
              <p className="p-6 text-sm text-gray-400">No results found.</p>
            ) : (
