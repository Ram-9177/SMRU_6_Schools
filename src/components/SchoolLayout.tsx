...
export default function SchoolLayout({ 
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#f3f7fc_0%,#eef3f9_100%)]">
      {/* ================= HERO ================= */}
      <section className="relative text-[#0d315c] pt-10 pb-10 md:pt-24 px-5 md:px-8 lg:px-16 text-center overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-20">
          ...
          <h1 className={`font-black font-outfit mb-3 tracking-tight leading-[0.95] uppercase mx-auto max-w-[98%] ${
            title.length > 40 
              ? "text-[clamp(1.6rem,4.8vw,3.2rem)]" 
              : title.length > 28
                ? "text-[clamp(2rem,6vw,4.2rem)]"
                : "text-[clamp(2.35rem,7vw,5.4rem)]"
          }`}>
            {title}
          </h1>
      ...
      {/* Admissions Notice */}
      <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-16 -mt-6 relative z-20">
        <div className="bg-[#fffaf1] border-2 border-[#ffaf3a]/30 p-4 cut-corner-panel shadow-xl flex flex-col sm:flex-row sm:items-center gap-4 animate-in fade-in slide-in-from-top-4 duration-700">
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-16 py-10 md:py-12">
        <div className="bg-[#fdfefe] cut-corner-panel shadow-[0_20px_44px_rgba(13,49,92,0.12)] border border-[#dbe6f3] overflow-hidden grid grid-cols-1 lg:grid-cols-[280px,1fr]">
          ...
          {/* Body */}
          <main className="p-5 sm:p-8 md:p-12 flex flex-col justify-between min-h-[420px] md:min-h-[500px] bg-[linear-gradient(180deg,#fbfdff_0%,#f7fbff_100%)]">
            <div>
               {sectionLabel && (
