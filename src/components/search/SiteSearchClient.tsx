...
function buildSearchItems(): SearchItem[] {
  ...
  const officialDocumentItems: SearchItem[] = [
    { title: "UGC Recognition under Section 2(f)", description: "View the official UGC recognition letter for St. Mary’s Rehabilitation University.", href: "/assets/St.%20Marys%20Rehabilitation%20University%20UGC%20recognition%20letter%202(f).pdf", type: "Official Document", keywords: "ugc recognition 2(f) official document letter" },
    { title: "University Establishment Act", description: "View the Telangana Gazette document establishing St. Mary’s Rehabilitation University through Act No. 10 of 2026.", href: "/assets/SMRU%20Act%2010%20of%202026.pdf", type: "Official Document", keywords: "university establishment act telangana gazette act 10 of 2026 official document" }
  ];
