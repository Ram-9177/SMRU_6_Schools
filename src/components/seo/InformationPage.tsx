...
export default function InformationPage({ config }: { config: InfoPageConfig }) {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[radial-gradient(circle_at_50%_0%,#f0f7ff_0%,#fcfdfe_50%,#f9fbff_100%)] pt-[120px] md:pt-[136px] pb-16">
          ...
          >
            ...
            <div className={`mb-8 inline-flex items-center gap-3 border border-slate-300 bg-gradient-to-r from-slate-50 to-white px-4 py-3 shadow-[0_8px_18px_rgba(15,23,42,0.08)] ${officialBadgeClip}`}>
              <div className="h-11 w-11 overflow-hidden border border-slate-300 bg-white p-1.5 [clip-path:polygon(0_0,100%_0,100%_78%,78%_100%,0_100%)] md:[clip-path:polygon(0_0,100%_0,100%_76%,76%_100%,0_100%)]">
                <img
                  src="/favicon.png"
                  alt="St. Mary's Rehabilitation University official mark"
              ...
              <div className="leading-tight">
                ...
                <p className="mt-1 text-xs font-black text-slate-700">St. Mary&apos;s Rehabilitation University</p>
              </div>
            </div>
        ...
        <section className="px-4 pt-8">
          <div className="mx-auto max-w-6xl space-y-8">
            ...
            {config.documents && (
              ...
              >
                <div className="mb-6 w-fit">
                  <h2 className="text-[13px] font-black uppercase tracking-[0.3em] text-[#0d315c]">Official Approval Documents (To Be Published)</h2>
                  ...
                  {config.documents.map((doc, i) => (
                    ...
                    >
                      ...
                      <div className="mt-4 flex items-center justify-between">
                        <span
                          className={`inline-flex bg-slate-200/50 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-slate-500 ${
                            officialBadgeClip
                          }`}
                        >
                          {doc.status}
                        ...
                        {doc.url ? (
                          <Link href={doc.url} className="text-[10px] font-black uppercase tracking-widest text-[#019e6e] hover:underline">
                            View Document
                          </Link>
                        ) : (
            ...
            <VerificationSection items={config.needsVerification || []} />
