    ...
    faqs: [
      {
        ...
        answer:
          "Open the program pages and compare duration, eligibility, fees, and career outcomes. If a field is still missing, treat it as pending publication until the university confirms it.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "The website states that St. Mary's University is established under the Telangana State Private Universities Act, 2018. Formal disclosure documents still need manual verification on the public website.",
      },
      {
        question: "When do PhD admissions close for 2026-27?",
        answer:
          "The website states that the application end date for PhD admissions 2026-27 is 10 April 2026 and the entrance test is scheduled for 26 April 2026.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "The website presents St. Mary's University as a rehabilitation-focused institution with seven schools, multiple healthcare and technology programs, and long-term academic legacy. Priority claims still need manual verification through public disclosures.",
      },
      {
