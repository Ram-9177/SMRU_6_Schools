...
export const ADMISSIONS_FAQS: SeoFaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. Program pages publish those details where they are available, and missing items should be treated as official details will be published by the university. For current verified guidance, please contact the official university helpdesk.",
  },
  {
...
export const PHD_FAQS: SeoFaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "The page currently lists 10 May 2026 as the application end date and 15 May 2026 as the entrance test date.",
  },
  {
