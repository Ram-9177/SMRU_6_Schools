...
export const buildSchoolAnswers = (school: any): SeoAnswerItem[] => {
  ...
  return [
    ...
    },
    {
      ...
      answer: "Use the official admissions and program links shown on this page to continue to the correct application route.",
    },
  ];
};
...
export const buildSchoolFaqs = (school: any) => {
  ...
  return [
    ...
    },
    {
      ...
      answer: "Open the department and program links from this school page to review individual program details, eligibility, and application routes.",
    },
    {
...
export const buildDepartmentAnswers = (school: any, department: any): SeoAnswerItem[] => {
  ...
  return [
    ...
    },
    {
      ...
      answer: "Use the program detail links and admission CTA on this page to move to the relevant admissions route.",
    },
  ];
};
...
export const buildProgramAnswers = (school: any, department: any, program: any): SeoAnswerItem[] => [
  ...
  },
  {
    ...
    answer:
      school && department
        ? `Use the admissions or enquiry actions shown on this program page. This program is listed under ${department.name} in ${school.name}.`
        : SEO_UPDATE_NOTE,
  },
];
