...
export const STATIC_ROUTE_REGISTRY: Record<StaticRouteKey, StaticRouteConfig> = {
  home: {
    metadata: buildMetadata({
      title: "St. Mary's Rehabilitation University | Admissions 2026 Hyderabad",
      description:
        "Official website of St. Mary's Rehabilitation University, Hyderabad. India's specialized institution for rehabilitation, health, and allied sciences. Admissions open for 2026 session.",
      pathname: "/",
      keywords: ["Admissions 2026", "Top University in Hyderabad", "Rehabilitation Sciences India", "SMRU Hyderabad"],
    }),
    View: Home,
  },
  about: {
