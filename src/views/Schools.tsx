...
export default function Schools() {
  ...
  const source = cmsItems.length ? cmsItems : staticSchools;
  const baseItems = useMemo(() => (source || []).map((s) => ({ ...s, slug: safeSlug(s.slug, s.name) })), [source]);
    ...
    baseItems.forEach((s) => {
      (s.departments || []).forEach((d) => {
        (d.programs || []).forEach((p) => {
          uniquePrograms.add(getCanonicalProgramKey(p.name, { extended: true }));
        });
      });
    });
    return { schoolsCount, deptCount, programCount: uniquePrograms.size };
  }, [baseItems]);

  return (
    <div className="min-h-screen bg-[#f5f9ff]">
      {/* ================= HERO ================= */}
      <section className="relative text-[#0d315c] pt-28 pb-12 px-6 text-center overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-20">
          ...
          <h1 className="text-5xl md:text-8xl lg:text-[6.5rem] font-black font-outfit mb-3 tracking-tight leading-[0.85] uppercase">
      ...
      <div className="max-w-7xl mx-auto px-4 mt-8">
        <div className="bg-[#fff9ef] border-l-4 border-[#ffaf3a] p-4 cut-corner-panel shadow-sm intro-fade-up">
      ...
      <div className="max-w-7xl mx-auto px-4 mt-4">
        <BigNumberGrid
          className="sm:grid-cols-3 lg:grid-cols-3 max-w-6xl mx-auto"
          showOrdinal={false}
          items={[
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="cut-corner-panel shadow-2xl border border-[#cfe4ff] overflow-hidden grid md:grid-cols-[260px,1fr] bg-[#edf6ff]" style={{ minHeight: 520 }}>
          ...
          <div className="bg-[linear-gradient(180deg,#f4f9ff_0%,#e8f3ff_100%)] flex flex-col">
            ...
            {/* Footer row */}
            {activeSchool && (
              <div className="px-6 md:px-8 py-5 border-t border-[#d7e8fb] bg-white flex flex-wrap items-center justify-between gap-3">
                <Link
      ...
      {SHOW_PUBLIC_SEO_SECTIONS && (
        <div className="max-w-7xl mx-auto px-4 pb-16 mt-16 space-y-16">
          ...
          <LinkGridSection
            ...
            items={[
              ...
              { href: "/placements", label: "Career & Placements", description: "Track records of institutional placement and industrial tie-ups." },
              { href: "/scholarships", label: "Financial Aid", description: "Explore scholarships and merit-based aid for students." },
            ]}
          />
        </div>
      )}
