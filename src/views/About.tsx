      ...
      <div className="container max-w-screen-xl mx-auto px-4">
        <header className="text-center mb-10" data-reveal="fade-up">
          ...
          <p className="mt-2 text-slate-600 max-w-3xl mx-auto">
            A clear, organized view of the teams steering St. Mary's Rehabilitation University.
          </p>
        </header>
...
export default function About() {
  ...
  const coreObjectives = [
    ...
    },
    {
      ...
      description:
        "Our structure of six focused schools allows students to dive deeply into Rehabilitation, Healthcare, Allied Sciences, Assistive Technology, Law, Management, and Technology, fostering both specialization and multidisciplinary collaboration.",
    },
    {
      ...
      <section className="relative w-full overflow-hidden min-h-[46vh] flex items-center justify-center">
        ...
        <div className="smru-container relative z-20 pt-8 md:pt-16 pb-6 md:pb-12 flex flex-col items-center justify-center text-center">
          ...
          <p
            ...
            style={{ "--delay": "0.08s" }}
          >
            St. Mary's Rehabilitation University empowers healthcare professionals to transform lives through world-class rehabilitation education, innovative research, and compassionate care.
          </p>
        </div>
      </section>
      ...
      <section id="overview" className="scroll-mt-24 smru-section bg-white">
        <div className="smru-container grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              <p>
                <strong>St. Mary’s Rehabilitation University</strong> is a rehabilitation-led university built to prepare skilled, ethical, and practice-ready professionals across rehabilitation, healthcare, allied sciences, assistive technology, law, management, technology, and multidisciplinary fields.
              </p>
              <p>
                Our <strong>six-school academic model</strong> focuses on delivering depth and specialization. We blend rigorous clinical training, evidence-based research, and a culture of empathy to create a <strong>student-first learning</strong> environment. 
              </p>
              <p>
          ...
          <div className="flex justify-center" data-reveal="fade-left">
            <img
              ...
              alt="St. Mary's Rehabilitation University Logo"
      ...
      <section id="establishment" className="scroll-mt-24 smru-section bg-slate-50">
        <div className="smru-container text-center">
          ...
          <p className="mt-8 text-lg text-slate-700 max-w-3xl mx-auto leading-relaxed font-medium">
            SMRU is established through Telangana Gazette Act No. 10 of 2026 and recognized by the University Grants Commission under Section 2(f) of the UGC Act, 1956. We maintain strict public transparency across all our academic and institutional operations.
          </p>
        ...
        <div className="smru-container text-center">
          ...
          <ConnectedPillars
            ...
            items={[
              ...
              { icon: <img src="/assets/SMRU Logo.png" className="w-6 h-6 object-contain" />, title: "Integrity", desc: "Transparent governance and ethical institutional practice." },
            ]}
          />
        </div>
      </section>
      ...
      <div className="bg-white smru-section">
        <div className="smru-container">
          <UniversitySectionHeader
            ...
            subtitle="The leadership structure of St. Mary's Rehabilitation University ensures academic excellence, statutory compliance, and transparent governance."
            className="mb-12"
          />
