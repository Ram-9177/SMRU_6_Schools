...
const QTST_PAGE_URL = "https://qtst.ai/qtst-smru.html";

export default function QtstSmru() {
  ...
  return (
    <div className="bg-white min-h-screen">
      <SEO title="QTST | St. Mary's Rehabilitation University" description="Quality Thought School of Technology (QTST) at St. Mary's Rehabilitation University." />
      ...
      <section className="bg-white px-0 py-0">
        <div className="w-full">
          <div className="overflow-hidden bg-white">
            <iframe
              ref={iframeRef}
              title="QTST at St. Mary's Rehabilitation University"
              src={QTST_PAGE_URL}
              loading="eager"
