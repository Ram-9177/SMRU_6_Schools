...
const getPartnerMeta = (partner) => {
  ...
  if (partner.redirectUrl?.startsWith("/")) {
    return {
      ...
      typeNote: "Structured partner page inside the SMRU ecosystem",
      icon: <FaLink />,
    };
  }
...
export default function Partner() {
      ...
      .map((partner, idx) => {
        ...
        return {
          ...
          shortDescription:
            ...
            "Partner-linked academic pathway designed to align learning with industry-facing outcomes.",
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Our Edupartners | St. Mary's Rehabilitation University"
        description="Explore strategic education and technology partners powering future-ready learning at St. Mary's Rehabilitation University."
      />
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-24 lg:px-10 xl:px-12 flex flex-col items-center text-center">
          <div className="max-w-4xl flex flex-col items-center">
            ...
            <p
              ...
              style={{ "--delay": "0.08s" }}
            >
              A curated network of academic, technology, and pathway partners that expands learning access while keeping the experience clear,
              polished, and institution-first.
            </p>
            ...
            >
              {[
                ...
                { value: String(partners.filter((item) => item.website || item.path).length).padStart(2, "0"), label: "Access Routes", color: "text-[#019e6e]" },
                { value: "01", label: "Unified Showcase", color: "text-[#cf8a19]" },
              ].map((item) => (
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div data-reveal="fade-up">
              ...
              <p className="mt-4 max-w-2xl text-sm leading-7 text-[#6b7682] md:text-base">
                Every partner is presented with the same visual weight. The color variation comes from the card accents and the logos themselves, not from one dominant brand block.
              </p>
            </div>
            <div
            ...
            <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
              {partners.map((partner, idx) => {
                ...
                return (
                  <CardWrapper
                    key={partner.id}
                    to={partner.isComingSoon ? undefined : partner.path}
