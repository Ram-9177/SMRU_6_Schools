...
const PhdAdmission = () => {
  ...
  const promise = [
    { title: "Structured Supervision", desc: "Every scholar is matched with a research supervisor aligned to their area of inquiry. Supervision at St. Mary's Rehabilitation University follows a structured mentoring framework with regular progress reviews." },
    ...
    { title: "Publication & Conference Support", desc: "St. Mary's Rehabilitation University encourages scholars to publish in indexed journals and present at national and international conferences. We provide guidance on ethics and manuscript development." },
    { title: "A Community, Not Just a Programme", desc: "From seminar series and research colloquia to informal mentorship, St. Mary's Rehabilitation University's scholars become part of a vibrant research community." }
  ];
  ...
  const applySteps = [
    ...
    { title: "Appear for Entrance Examination", desc: "Qualify in the St. Mary's Rehabilitation University Ph.D. entrance examination (Exempted for JRF/GATE)." },
  ...
  return (
    <div className="bg-white font-outfit text-[#0d315c] selection:bg-[#019e6e]/10">
      ...
      {/* -------------------------------------------------------------------
          ...
          ------------------------------------------------------------------- */}
      <section className="relative overflow-hidden bg-[#071a32] min-h-[calc(100svh-112px)] md:min-h-screen flex flex-col justify-start">
           ...
           <div className="smru-global-ticker-track">
             {[1, 2, 3, 4, 5, 6].map((i) => (
               ...
               >
                 ...
                 Notice: PhD Admissions 2026-27 — Application End Date: 10-May-2026 | Entrance Test Date: 15-May-2026 — Click for official notice
               </a>
             ))}
           </div>
         </div>
         ...
         <div className="relative z-20 w-full h-full flex flex-col">
           ...
           <div className="w-full bg-[#019e6e] py-4 px-5 md:px-8 text-center border-b-4 border-[#ffaf3a] shadow-xl">
             <h2 className="text-white text-base md:text-2xl font-black uppercase tracking-[0.2em] md:tracking-[0.3em] drop-shadow-lg">
           ...
           <div className="container mx-auto px-5 md:px-8 lg:px-16 flex-grow flex flex-col md:flex-row items-center justify-center gap-10 md:gap-16 lg:gap-24 xl:gap-32 py-10 md:py-20 relative z-20">
             ...
             <div className="w-full max-w-[500px] md:w-[460px] lg:w-[500px] relative">
            ...
            <div className="flex flex-col md:flex-row cut-corner-panel overflow-hidden shadow-2xl">
               <div className="md:w-1/2 bg-[#1b437c] p-10 md:p-14 flex items-center gap-8">
                  ...
                  <div className="text-white">
                     ...
                     <p className="mt-4 text-xl font-bold italic text-white/80">10 May 2026</p>
                  </div>
               </div>
               <div className="md:w-1/2 bg-white p-10 md:p-14 flex items-center gap-8 border-t md:border-t-0 md:border-l border-gray-100">
                  ...
                  <div className="text-[#0d315c]">
                     ...
                     <p className="mt-4 text-xl font-bold italic text-gray-500">15 May 2026</p>
                  </div>
               </div>
            </div>
      ...
      {/* -------------------------------------------------------------------
          VISION & WHY St. Mary's Rehabilitation University (Textured Background)
          ------------------------------------------------------------------- */}
            ...
            <div className="flex flex-col lg:flex-row gap-24 items-start">
               <div className="lg:w-1/3">
                  <h2 className="text-4xl font-extrabold tracking-tighter text-[#0d315c] leading-tight uppercase">
                     Why Pursue Your <br />Doctorate at St. Mary's Rehabilitation University
                  </h2>
               ...
               <div className="lg:w-2/3 space-y-10 text-[18px] text-gray-500 font-medium leading-relaxed">
                  <p>
                     India’s rehabilitation, allied health, and inclusive-care sectors face a critical shortage of research leaders. St. Mary's Rehabilitation University's doctoral programme exists to develop exactly these professionals. Not a department, but an entire ecosystem embedded within India’s first and only rehabilitation university.
                  </p>
            ...
            <div className="smru-container space-y-16">
               <LinkGridSection
                 ...
                 items={[
                   ...
                   LOCATION_LINKS[0],
                   TRUST_LINKS[2],
                   { href: "/fee-structure", label: "Fee Structure", description: "Official details will be published by the university. For current verified guidance, please contact the official university helpdesk." },
                 ].filter(Boolean)}
               />
