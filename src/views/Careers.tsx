...
import cls1 from "../assets/Cls1.jpeg";
import cls2 from "../assets/cls2.jpeg";
...
export default function Careers() {
  ...
  return (
    <section className="w-full bg-gray-50">
      <SEO
        title="Careers | St. Mary's Rehabilitation University"
        description="Join St. Mary's Rehabilitation University — careers in rehabilitation and allied health education. Faculty, clinical, technical roles and more."
        keywords={["st mary's university careers","stmarys jobs","university jobs hyderabad","rehabilitation careers"]}
      ...
      >
        ...
        <div className="relative z-20 max-w-6xl mx-auto px-4 py-20 flex flex-col items-center justify-center text-center">
          ...
          <p
            ...
            style={{ "--delay": "0.08s" }}
          >
            Join India's specialized university dedicated to rehabilitation and allied health sciences.
          </p>
      ...
      <section id="why-join-careers" className="scroll-mt-24 max-w-5xl mx-auto px-4 pb-16">
        <div className="relative overflow-hidden cut-corner-panel shadow-lg ring-1 ring-black/5 p-10 text-[#0f1736]">
          ...
          <div className="relative text-center">
            <h2 className="text-3xl font-bold mb-4 tracking-tight">Why Join St. Mary's Rehabilitation University?</h2>
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: <FaAward />, title: "30+ Years of Experience", desc: "A proven track record of excellence since 1996." },
              { icon: <FaChartLine />, title: "Strong Placement Track Record", desc: "Consistent placement of graduates in leading healthcare organizations." },
            ].map((item, i) => (
              <article
                key={i}
