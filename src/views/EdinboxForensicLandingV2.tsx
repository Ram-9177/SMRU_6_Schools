      ...
      <div className="bg-[#0f2d23] py-2 text-[12px] text-white/70">
        <div className="container mx-auto px-4 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-4 flex-wrap">
            <a href="tel:08035018480" className="hover:text-[#e8971f] transition-colors flex items-center gap-1.5">
              <FaPhone className="text-[10px]" /> 08035018480
            </a>
            <a href="mailto:support@edinbox" className="hover:text-[#e8971f] transition-colors flex items-center gap-1.5 border-l border-white/15 pl-4">
              <FaEnvelope className="text-[10px]" /> support@edinbox
            </a>
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3 border-r border-white/15 pr-4">
              <a href="#" className="hover:text-[#e8971f] transition-colors"><FaFacebookF /></a>
              <a href="#" className="hover:text-[#e8971f] transition-colors"><FaInstagram /></a>
              <a href="#" className="hover:text-[#e8971f] transition-colors"><FaYoutube /></a>
              <a href="#" className="hover:text-[#e8971f] transition-colors"><FaLinkedinIn /></a>
            </div>
            <a href="https://aifset.com/" className="bg-[#e8971f] text-white px-4 py-1 rounded font-bold hover:bg-[#f5b042] transition-colors">
              Apply Now
            </a>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 flex items-center justify-between h-[65px]">
          <div className="flex items-center gap-6 border-r border-white/15 pr-6 h-full py-2">
            <div className="flex flex-col leading-none">
              <span className="font-outfit text-xl font-black text-white tracking-wider">ST.MARY'S</span>
          ...
          <ul className={`lg:flex items-stretch h-full font-bold text-[14px] text-white/90 gap-1 ${isNavOpen ? 'absolute top-full left-0 w-full bg-[#1b5c48] flex-col p-4 space-y-2 h-auto shadow-xl' : 'hidden'}`}>
            <li className="flex"><a href="#" className="flex items-center px-4 hover:bg-[#133d30] hover:border-b-4 hover:border-[#e8971f] active">Home</a></li>
            ...
            <li className="flex"><a href="#" className="flex items-center px-4 hover:bg-[#133d30]">Careers</a></li>
            <li className="flex"><a href="#" className="flex items-center px-4 hover:bg-[#133d30]">Contact</a></li>
          </ul>

          <div className="hidden lg:flex items-center ml-auto pl-4">
            <a href="https://aifset.com/" className="bg-[#e8971f] text-white px-6 py-2.5 rounded font-black text-[13px] uppercase tracking-wider hover:bg-[#f5b042] transform hover:-translate-y-0.5 transition-all flex items-center gap-2 shadow-lg">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-in-up">
              ...
              <p className="text-white/85 text-lg md:text-xl max-w-xl leading-relaxed mb-10 font-light">
                Build a career in one of India's most sought-after fields. SMRU × AIFSET makes forensic science education accessible to every eligible student in India — via a single online entrance exam.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 mb-14">
                <a 
                  href="https://aifset.com/"
      ...
      <section className="py-24 bg-white" id="about">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-20 reveal">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-[#1a2e28] font-outfit mb-6 italic">Why Join <span className="text-[#1b5c48] not-italic">SMRU?</span></h2>
            <div className="w-16 h-1 bg-[#e8971f] mx-auto mb-8" />
            <p className="text-lg text-[#3d5a52] leading-relaxed">
              SMRU and AIFSET eliminate the confusion around admissions — one exam, full support, and a university that stands alone in India.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-16">
            <div className="max-w-2xl reveal">
              ...
              <p className="text-lg text-white/75 leading-relaxed font-light">
                The All India Forensic Science Entrance Test is conducted online, multiple times a year, and designed to be accessible to every eligible student in India. One exam — seamless admission to SMRU.
              </p>
            </div>
            <a 
              href="https://aifset.com/" 
      ...
      <section className="py-24 bg-white" id="process">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-20 reveal">
            ...
            <div className="w-16 h-1 bg-[#e8971f] mx-auto mb-8" />
            <p className="text-lg text-[#3d5a52] leading-relaxed">
              A straightforward 5-step path from your home to a confirmed seat at SMRU — fully guided by AIFSET counsellors.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 relative">
            {[
              ...
              { num: "4", title: "Apply to SMRU", desc: "Submit your AIFSET score directly to SMRU via the AIFSET counselling portal." },
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="reveal">
              ...
              <p className="text-lg text-[#3d5a52] leading-relaxed mb-8">
                A B.Sc Forensic Science from SMRU opens doors across government labs, law enforcement, private agencies, and research — nationwide.
              </p>
              <a 
                href="https://aifset.com/" 
                className="bg-[#1b5c48] text-white px-10 py-5 font-black text-[14px] uppercase tracking-wider rounded shadow-xl hover:bg-[#227055] transition-all inline-block"
      ...
      <section className="py-24 bg-gradient-to-br from-[#133d30] via-[#1b5c48] to-[#133d30] relative overflow-hidden text-center text-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none mb-8 font-outfit">
            Scholarships at <span className="text-[#f5b042] italic">SMRU</span>
          </h2>
      ...
      <section className="py-24 bg-[#0f2d23] text-center relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <blockquote className="text-2xl md:text-4xl font-black text-white italic max-w-4xl mx-auto leading-[1.3] tracking-tight font-outfit mb-12">
            "At SMRU, I help learners find their voice — combining cutting-edge forensic science education with hands-on investigative training to transform every graduate into a highly sought-after professional."
          </blockquote>
          <div className="flex flex-col items-center">
            <div className="text-[#f5b042] font-black uppercase tracking-[0.3em] text-sm">Dr. Shiva Deekshith</div>
            <div className="text-white/40 text-[11px] font-bold uppercase tracking-[0.2em] mt-2">Dean, School of Forensic Sciences — SMRU</div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-[1fr_2fr] gap-12">
                ...
                <ul className="space-y-4">
                  {["Admissions", "Programmes", "Campus & Facilities", "Scholarships", "Career Support"].map((item) => (
                    <li key={item} className="group">
                      <a href="#" className="text-[#3d5a52] font-black text-[14px] hover:text-[#1b5c48] transition-colors flex items-center gap-2">
            ...
            <div className="space-y-3 reveal">
              {[
                { q: "Is AIFSET recognised by SMRU?", a: "Yes. SMRU accepts AIFSET scores as the primary admission pathway for B.Sc Forensic Science. It is the official and only entrance route for this programme through the AIFSET partnership." },
                ...
                { q: "Can I apply from outside Hyderabad?", a: "Absolutely. AIFSET is fully online and SMRU admits students from all states across India. Your location is not a barrier — all you need is an internet connection and the right qualifications." },
                ...
                { q: "What support does AIFSET provide?", a: "AIFSET provides free academic counselling, document guidance, regional on-ground support across India, and complete hand-holding through every step of the SMRU admission process." },
              ].map((faq, idx) => (
      ...
      <section className="py-24 relative overflow-hidden text-center text-white" id="register">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none mb-10 font-outfit">
            Register for AIFSET.<br /><span className="text-[#f5b042] italic">Choose SMRU. Build India.</span>
          </h2>
          <p className="text-white/75 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mb-12 font-light">
          ...
          <div className="mt-16 text-[10px] font-black uppercase tracking-[0.4em] text-white/30 space-x-4">
            <span>SMRU × AIFSET Partnership</span>
      ...
      <footer className="bg-[#0f2d23] pt-20 pb-10 text-white/50 border-t border-white/5">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            <div className="md:col-span-1">
              <div className="flex flex-col mb-6">
                <span className="font-outfit text-2xl font-black text-white leading-none">ST.MARY'S</span>
              ...
              <p className="text-[13px] leading-relaxed mb-8 pr-4">
                India's premier institutional framework for specialized rehabilitation and forensic sciences education.
              </p>
              <div className="flex gap-3">
                {[FaFacebookF, FaInstagram, FaYoutube, FaLinkedinIn].map((Icon, i) => (
                  <a key={i} href="#" className="w-9 h-9 border border-white/10 rounded flex items-center justify-center hover:bg-[#1b5c48] hover:border-[#1b5c48] hover:text-white transition-all">
                    <Icon size={14} />
                  </a>
                ))}
              </div>
            ...
            <div className="md:col-span-1">
              ...
              <ul className="space-y-3 text-[14px]">
                <li><a href="#" className="hover:text-[#f5b042] transition-colors">About SMRU</a></li>
                <li><a href="#" className="hover:text-[#f5b042] transition-colors">AIFSET Entrance</a></li>
                <li><a href="#" className="hover:text-[#f5b042] transition-colors">Academic Schools</a></li>
                <li><a href="#" className="hover:text-[#f5b042] transition-colors">Admissions 2025</a></li>
              </ul>
            </div>
            ...
            <div className="md:col-span-1">
              ...
              <ul className="space-y-3 text-[14px]">
                <li><a href="#" className="hover:text-[#f5b042] transition-colors">Privacy Policy</a></li>
                <li><a href="#" className="hover:text-[#f5b042] transition-colors">Terms of Service</a></li>
                <li><a href="#" className="hover:text-[#f5b042] transition-colors">Mandatory Disclosure</a></li>
                <li><a href="#" className="hover:text-[#f5b042] transition-colors">Contact Support</a></li>
              </ul>
            </div>
          ...
          <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] font-bold uppercase tracking-widest">
            <p>© 2026 St. Mary's Rehabilitation University. All Rights Reserved.</p>
