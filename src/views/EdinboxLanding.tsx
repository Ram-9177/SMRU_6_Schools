    ...
    <div className="min-h-screen bg-white text-[#0d315c] font-outfit">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                <button 
                  onClick={() => window.open("https://aifset.com/", "_blank")}
      ...
      <section className="py-24 bg-white" id="about">
        <div className="container mx-auto px-4">
          <UniversitySectionHeader 
            title={<>Why Join <span className="text-[#019e6e] italic">SMRU?</span></>}
            subtitle="SMRU and AIFSET eliminate the confusion around admissions — one exam, full support, and a university that stands alone in India."
            className="mb-16"
          />
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-20">
            <div className="max-w-2xl">
              <UniversitySectionHeader 
                ...
                subtitle="The All India Forensic Science Entrance Test is conducted online, multiple times a year, and designed to be accessible to every eligible student in India. One exam — seamless admission to SMRU."
      ...
      <section className="py-24 bg-white" id="process">
        <div className="container mx-auto px-4">
          <UniversitySectionHeader 
            ...
            subtitle="A straightforward 5-step path from your home to a confirmed seat at SMRU — fully guided by AIFSET counsellors."
            className="mb-16"
          />
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap lg:flex-nowrap items-stretch justify-center gap-6">
            {[
              ...
              { num: "4", title: "Apply to SMRU", desc: "Submit your AIFSET score directly to SMRU via the portal." },
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="reveal">
              <UniversitySectionHeader 
                ...
                subtitle="A B.Sc Forensic Science from SMRU opens doors across government labs, law enforcement, private agencies, and research — nationwide."
              />
              <button 
                onClick={() => openApply("forensic")}
                className="mt-10 bg-[#0d315c] text-white px-12 py-5 font-black text-sm uppercase tracking-[0.2em] cut-corner-badge shadow-xl hover:bg-[#019e6e] transition-all"
      ...
      <section className="py-32 bg-gradient-to-br from-[#082244] to-[#0d315c] relative overflow-hidden text-center text-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none mb-8">
            Scholarships at <span className="text-[#ffaf3a] italic">SMRU</span>
          </h2>
      ...
      <section className="py-24 bg-[#082244] text-center">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12">
            ...
            <div className="text-white/40 text-xs font-medium uppercase tracking-[0.2em] mt-2">Dean, School of Forensic Sciences — SMRU</div>
          </div>
        </div>
      </section>
            ...
            <div className="grid md:grid-cols-[1fr_2fr] gap-12">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { q: "Can I apply from outside Hyderabad?", a: "Absolutely. AIFSET is fully online and SMRU admits students from all states across India. Your location is not a barrier — all you need is an internet connection." },
      ...
      <section className="py-32 relative overflow-hidden text-center text-white" id="register">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none mb-8">
            Register for AIFSET.<br /><span className="text-[#ffaf3a] italic">Choose SMRU. Build India.</span>
          </h2>
          <p className="text-white/70 text-lg max-w-2xl mx-auto leading-relaxed mb-12">
