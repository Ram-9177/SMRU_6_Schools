...
export default function AcademicStructure() {
  ...
  return (
    <div className="min-h-screen bg-white font-outfit text-[#0d315c] selection:bg-[#019e6e]/10">
      <SEO 
        title="Academic Structure | St. Mary's Rehabilitation University"
        description="Explore the complete academic catalogue of St. Mary's Rehabilitation University. Over 70 programs across diverse schools of engineering, rehabilitation, and health sciences."
      />
        ...
        <div className="relative z-10 container mx-auto px-6 text-center space-y-10 max-w-5xl">
          ...
          >
            ...
            <p className="mt-8 text-lg md:text-2xl text-slate-500 font-medium italic leading-relaxed opacity-80 max-w-3xl mx-auto">
              A comprehensive architecture of clinical mastery, engineering innovation, and research leadership across St. Mary's Rehabilitation University's specialized schools.
            </p>
          </motion.div>
