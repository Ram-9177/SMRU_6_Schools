...
export default function PartnerIframePage({ slug }: { slug: string }) {
  ...
  const externalFallbackBySlug: Record<string, string> = {
    ...
    emversity: "https://emversity.com/university-partners/st-marys-rehabilitation-university-hyderabad",
  ...
  return (
    <>
      <SEO
        title={`${partner.name || "Partner"} | St. Mary's Rehabilitation University`}
        description={partner.shortDescription || `Explore ${partner.name || "our partner"} at St. Mary's Rehabilitation University.`}
