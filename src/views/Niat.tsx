  ...
  return (
    <>
      <SEO 
        ...
        description="Explore the NIAT programs in collaboration with St. Mary's Rehabilitation University."
      ...
      <AnimatePresence mode="wait">
        {!isIframeLoaded && (
          ...
          >
            ...
            >
              {/* Central St. Mary's Rehabilitation University Logo with pulsing effect */}
              <motion.img 
