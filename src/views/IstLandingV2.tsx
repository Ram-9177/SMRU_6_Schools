...
const THEME = {
  primary: "#0d315c",    // SMRU Deep Blue
  secondary: "#019e6e",  // SMRU Teal/Green
  accent: "#ffaf3a",     // SMRU Orange
...
const HIGHLIGHTS = [
  {
    ...
    desc: "Earn a valid B.Tech degree from St. Mary's Rehabilitation University.",
    icon: <FaCertificate />,
  },
  {
...
const FAQS = [
  {
    ...
    a: "Yes, the degree is awarded by St. Mary's Rehabilitation University, which is established under the Telangana Gazette Act and recognized by the UGC.",
  },
  {
  ...
  },
  {
    ...
    a: "We offer 100% placement assistance, including mock interviews, resume building, and direct access to 500+ top-tier hiring partners.",
  },
];

const IstLandingV2 = () => {
  const handleApply = () => {
    window.open("https://apply.smru.edu.in/", "_blank");
  };
  ...
  return (
    <div className="bg-white font-sans text-slate-900 overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md border border-white/20 px-4 py-2 rounded-full mb-8">
                ...
                <span className="text-white/90 text-xs font-bold uppercase tracking-widest">Admissions Open 2025-26</span>
              </div>
      ...
      {/* The SMRU + Intellipaat Advantage */}
          ...
          <div className="bg-[#0d315c] cut-corner-panel overflow-hidden flex flex-col lg:flex-row">
            <div className="lg:w-1/2 p-12 md:p-20 flex flex-col justify-center">
              ...
              <div className="space-y-6">
                {[
                  "UGC Recognized B.Tech Degree from SMRU",
          ...
          <div className="bg-[#1d4ed8] p-12 md:p-24 cut-corner-panel text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="mt-12 text-white/50 text-xs font-bold uppercase tracking-[0.2em]">
                St. Mary's Rehabilitation University × Intellipaat
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="py-10 border-t border-slate-100">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-[#0d315c] font-black text-xl">SMRU × IST</div>
          <div className="text-slate-400 text-sm">© 2025 St. Mary's Rehabilitation University. All Rights Reserved.</div>
          <div className="flex gap-8 text-slate-400 text-xs font-bold uppercase tracking-widest">
            <a href="#" className="hover:text-[#1d4ed8]">Privacy</a>
            <a href="#" className="hover:text-[#1d4ed8]">Terms</a>
            <a href="#" className="hover:text-[#1d4ed8]">Contact</a>
          </div>
        </div>
      </footer>
    </div>
