  ...
  return (
    <>
      ...
      <StructuredData
        ...
        data={buildContactPageSchema("/contact")}
      />
      {CONTACT_FAQS.length > 0 && (
        <StructuredData
          id="contact-faq-schema"
          data={buildFaqSchema(CONTACT_FAQS.map(f => ({ question: f.q, answer: f.a })))}
        />
      )}
      <section id="contact-hero" className="scroll-mt-24 relative w-full min-h-[46vh] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-20 max-w-6xl mx-auto px-4 pt-20 pb-10 md:pb-12 flex flex-col items-center justify-center text-center">
          ...
          <p
            ...
            style={{ "--delay": "0.08s" }}
          >
            Regional authority hub for rehabilitation and allied health education in South India. Our Deshmukhi campus is strategically located near Ramoji Film City, Hyderabad.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 grid gap-12 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-12">
            <div>
              ...
              <div className="grid gap-8 md:grid-cols-2">
                  ...
                  <div className="flex gap-4" data-reveal="fade-up">
                    ...
                    <div>
                      ...
                      <address className="text-[14px] font-bold text-[#0d315c] not-italic leading-relaxed">
                        ...
                        Near Ramoji Film City, Deshmukhi,<br />
                ...
                <div className="bg-[#f8fafc] border border-[#bae6fd] cut-corner-panel p-6 space-y-4">
                   <h4 className="text-[12px] font-black text-[#0369a1] uppercase tracking-widest flex items-center gap-2">
            ...
            <div className="pt-8 border-t border-slate-200">
               ...
               <div className="grid gap-6 md:grid-cols-2">
                  ...
                  <div className="p-6 bg-white border border-slate-100 cut-corner-card shadow-sm space-y-3">
                     ...
                     <p className="text-[13px] font-medium text-slate-600 leading-relaxed">
                       Located 5 minutes from the Ramoji Film City main gate. Easily accessible via university shuttle buses from major pickup points in Hyderabad.
                     </p>
                  </div>
               </div>
            </div>
            ...
            >
              <div className="h-[400px] w-full">
                <iframe
                  title="St. Mary's Rehabilitation University Campus Location"
                  loading="lazy"
          ...
          <div className="space-y-8">
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div>
                  ...
                  <p className="mt-2 text-slate-500 font-medium leading-relaxed">
                    Get expert guidance on program selection, eligibility, and the 2026-27 admission process.
                  </p>
                </div>
            ...
            <div className="bg-[#f8fafc] border border-[#dce7f3] cut-corner-panel p-8 space-y-6">
               <h4 className="text-[12px] font-black text-[#0d315c] uppercase tracking-widest border-b border-[#dce7f3] pb-3">Corporate & Support</h4>
               <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <FaShieldAlt className="mt-1 text-[#019e6e]" />
                    <div>
                      <p className="text-[11px] font-black uppercase tracking-widest text-slate-400">Campus Safety</p>
                      <p className="text-[14px] font-bold text-[#0d315c]">24/7 Security: +91 90104 55590</p>
                    </div>
                  </div>
               </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            <LinkGridSection
              ...
              items={[
                ...
                { href: "/visit-campus", label: "Visit Campus", description: "Campus visit planning page with contact guidance." },
                { href: "/how-to-reach-smru", label: "How to Reach SMRU", description: "Public route and campus access guidance." },
                { href: "/contact-directory", label: "Contact Directory", description: "Public contact routes listed on the website." },
                { href: "/grievance-redressal", label: "Grievance Redressal", description: "Public grievance workflow placeholder pending official verification." },
