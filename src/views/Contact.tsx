          ...
          <div className="space-y-8">
            ...
            <div className="bg-[#f8fafc] border border-[#dce7f3] cut-corner-panel p-8 space-y-6">
               ...
               <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <img src="/assets/SMRU Logo.png" className="w-5 h-5 object-contain mt-1" alt="Safety" />
                    <div>
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            <LinkGridSection
              ...
              items={[
                ...
                { href: "/grievance-redressal", label: "Grievance Redressal", description: "Official details will be published by the university. For current verified guidance, please contact the official university helpdesk." },
