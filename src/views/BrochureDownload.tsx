...
export default function BrochureDownload() {
  ...
  return (
    <div className="relative min-h-screen bg-[#f8fafc] flex items-center justify-center px-4 overflow-hidden">
      ...
      <SEO
        title="Download Brochure | St. Mary's Rehabilitation University"
        description="Download St. Mary's Rehabilitation University's official university flyer with programs, facilities, and admissions info."
        keywords={["st mary's university brochure","stmarys flyer","university brochure download","rehabilitation university brochure"]}
      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-white cut-corner-panel shadow-2xl p-8 text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-4">
            Download St. Mary's Rehabilitation University Flyer
          </h1>
