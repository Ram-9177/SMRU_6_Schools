  ...
  return (
    <>
      <SEO 
        ...
        description="Access the St. Mary's Rehabilitation University BlackBucks education portal for advanced technical training."
      ...
      <div className="blackbucks-iframe-wrapper relative bg-white">
        <iframe
          ...
          title="St. Mary's Rehabilitation University BlackBucks Portal"
          loading="eager"
