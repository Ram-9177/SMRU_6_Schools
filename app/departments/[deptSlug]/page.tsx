...
export function generateMetadata({ params }: { params: { deptSlug: string } }): Metadata {
  ...
  return buildMetadata({
    title: `${department?.name || "Department"} | St. Mary's Rehabilitation University`,
    description: department?.about || "Explore department programs at St. Mary's Rehabilitation University.",
    pathname: targetPath,
