...
export const metadata: Metadata = buildMetadata({
  title: "Departments",
  description: "Browse the public department directory for St. Mary's Rehabilitation University schools and academic pathways.",
  pathname: "/departments",
  keywords: ["departments", "academic departments", "SMRU departments"],
});
